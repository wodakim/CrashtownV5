...
- [ ] Aucun bug P0/P1 introduit sur gameplay principal (validation manuelle gameplay en cours).
...
- [ ] Validation gameplay manuelle approfondie (fairness/faux positifs).


## 5) Validation physique requise (MANUEL — toi)
