...
- **Sprint actif:** Sprint 5
- **Règle d'ordre:** Sprint 4 clôturé; exécution en cours strictement sur Sprint 5.
- **Blocants actuels Sprint 5:** aucun blocant P0 identifié au démarrage (surveillance fairness/perf active).
...
- [ ] Validation gameplay manuelle approfondie Sprint 5 (fairness/ressenti).
